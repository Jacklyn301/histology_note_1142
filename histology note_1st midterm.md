---
title: histology note_1st midterm
...
| **電子顯微鏡 (Electron microscope)** | 利用電子束當光，電磁鐵當物鏡跟目鏡。電子聚焦到樣本上後反射，儀器偵測這些反射的電子，形成影像。SEM看表面，解析度低；TEM看內部，解析度高 | TEM：細胞超微結構 (如線粒體、核膜)。<br/>SEM：表面形態 (如病毒外殼、細胞膜凹凸)。 |
...
|---------|----------------|--------|------------|---|
|![image](https://vitrovivo.com/wordpress/wp-content/uploads/2018/01/Oil-Red-O-Stain-Mouse-Liver-4-20x-1536x852.jpg)|![image](https://neuromuscular.wustl.edu/pics/biopsy/titin/titinrecatp43.jpg)|![image alt](https://as2.ftcdn.net/v2/jpg/02/91/10/21/1000_F_291102152_1bLSktfAP5WubmyknVKuIMRbMUD9rAji.jpg)|![image](https://thumbs.dreamstime.com/z/human-anterior-pituitary-reticular-fibers-silver-stain-pituitary-anterior-lobe-silver-method-reticular-fibers-glandular-cell-236465761.jpg)|![image](https://www.pathologyoutlines.com/imgau/stainspaszuckerman08.jpg)|
...
![image alt](https://3.bp.blogspot.com/-7hysIVzRkPU/T9TLRp5c1KI/AAAAAAAAAoQ/rY-6vSNZfuk/s1600/Nuclear+Pore+Complex.jpg)
...
![image alt](https://rsscience.com/wp-content/uploads/2021/01/Lysosome-formation.jpg)
...
![image alt](https://www.frontiersin.org/files/Articles/1124907/fcell-11-1124907-HTML/image_m/fcell-11-1124907-g002.jpg)
...
![image alt](https://www.nature.com/scitable/content/ne0000/ne0000/ne0000/ne0000/14673338/U3.cp2.2_nrn2631-i1.jpg)
...
![image alt](https://rsscience.com/wp-content/uploads/2022/04/type-of-epithelial-tissue-examples.jpg)
...
![image alt](https://labster-image-manager.s3.amazonaws.com/v2/BSL/49084675-4979-4f25-b09e-278a9a5ec50b/BSL_Cell_Junction.en.png)
...
<details>
<summary>👉 點擊了解Metachromasia</summary>
...
![image alt](https://e-aair.org/ArticleImage/9999AAIR/aair-10-268-g002-l.jpg)
...
![image alt](https://i0.wp.com/ipscell.com/wp-content/uploads/2021/06/Whartons-jelly.png?resize=1200%2C678&ssl=1)
...
![image alt](https://image1.slideserve.com/3147013/glycosaminoglycans-l.jpg)
...
![image alt](https://physiotherapymilan.it/wp-content/uploads/2015/02/elastic-fibre.png)
...
```mermaid
flowchart LR
TAG(三酸甘油脂<br>TAG)-->|透過|ATGL((ATGL))-->|形成|DAG(二醯甘油<br>DAG)-->|透過|HSL((HSL))-->|形成|MAG(單醯甘油<br>MAG)-->|透過|MGL((MGL))-->|形成|G(甘油)
...
|---|-----------------|-----------------|--------------|
|組織切片|![image](https://medcell.org/histology/connective_tissue_lab/images/hyaline_cartilage.jpg)|![image](https://medcell.org/histology/connective_tissue_lab/images/elastic_cartilage.jpg)|![image](https://medcell.org/histology/connective_tissue_lab/images/fibrocartilage.jpg)|

![image alt](https://assets.lybrate.com/f_auto,c_limit,w_3840,q_auto/imgs/tic/enadp/image-of-the-cartilage.jpg)
...
![image alt](https://books.byui.edu/content_images/bio_265_anatomy_phy_II/WEJD_1.jpg)
...
![image alt](https://i.pinimg.com/originals/66/3c/d1/663cd15a7d765e9b88a1686aefb9b97e.png)
...
![image alt](https://www.frontiersin.org/files/Articles/644986/fcell-09-644986-HTML/image_m/fcell-09-644986-g001.jpg)
...
![image alt](https://o.quizlet.com/ROcB6812dvq7sA-9sj1OLg_b.png)
...
start{CFU-GEMM}:::stem
start --> BFUE(BFU-E<br>祖細胞一號):::early
BFUE --> CFUE(CFU-E<br>祖細胞二號):::early
CFUE --> pe(原紅血球<br>proerythroblast):::basophilic
pe --> bpe(嗜鹼性成紅血球<br>basophilic<br>erythroblast):::basophilic
bpe --> pcpe(多染性成紅血球<br>polychromatophilic<br>erythroplast):::polychromatic
pcpe --> ocmpe(正染性成紅血球<br>orthochromatophilic<br>erythroblast):::orthochromatic
ocmpe -->|排出細胞核| retic(網狀紅血球<br>reticulocyte):::reticulocyte
retic --> e(紅血球<br>erythrocyte):::erythrocyte

classDef stem fill:#a8d8ff,stroke:#2980b9,stroke-width:2.5px,color:#000
classDef early fill:#d6eaff,stroke:#3498db,stroke-width:2px,color:#000
classDef basophilic fill:#ffb3b3,stroke:#c0392b,stroke-width:2px,color:#000
classDef polychromatic fill:#ffcc99,stroke:#e67e22,stroke-width:2px,color:#000
classDef orthochromatic fill:#ffe0b3,stroke:#d4ac0d,stroke-width:2px,color:#000
classDef reticulocyte fill:#e0d6ff,stroke:#8e44ad,stroke-width:2px,color:#000
classDef erythrocyte fill:#ffcccc,stroke:#e74c3c,stroke-width:2px,color:#000
```
...
flowchart LR
    start{CFU-GEMM}:::stem
    start-->A(Myeloblast<br>骨髓母細胞):::early
    A --> B(Promyelocyte<br>早幼粒細胞<br>初級顆粒出現):::early
    B --> C(Myelocyte<br>幼粒細胞<br>在此處開始分化):::myelocyte
    C --> D(Metamyelocyte<br>後幼粒細胞<br>核呈腎形):::metamyelocyte
    D --> E(stab cell<br>刺狀細胞<br>核呈馬蹄形):::stab
    E --> F1([Neutrophil<br>2–5葉核]):::neutrophil
    E --> F2([Eosinophil<br>雙葉核]):::eosinophil
    E --> F3([Basophil<br>不規則核]):::basophil

classDef stem fill:#a8d8ff,stroke:#2980b9,stroke-width:2.5px,color:#000
classDef early fill:#d6eaff,stroke:#3498db,stroke-width:2px,color:#000
classDef myelocyte fill:#b3d9ff,stroke:#1f4e79,stroke-width:2px,color:#000
classDef metamyelocyte fill:#99ccff,stroke:#2980b9,stroke-width:2px,color:#000
classDef stab fill:#7fb3d5,stroke:#1f4e79,stroke-width:2px,color:#000
classDef neutrophil fill:#ffb3b3,stroke:#c0392b,stroke-width:2px,color:#000
classDef eosinophil fill:#d6f5d6,stroke:#27ae60,stroke-width:2px,color:#000
classDef basophil fill:#fff0b5,stroke:#daa520,stroke-width:2px,color:#000
...
![image alt](https://raw.githubusercontent.com/Jacklyn301/image_bank/main/platelet_in_primary_hemostasis_0423.png)
...
![image alt](https://d16qt3wv6xm098.cloudfront.net/ngcA2DcqQfmgWBTaL0dnJzdKRKKRbOth/_.png)
...
![image](https://raw.githubusercontent.com/Jacklyn301/image_bank/main/skeletal_muscle_structure_0423.png)
...
![image alt](https://image5.slideserve.com/9419008/a-sarcomere-the-functional-unit-of-skeletal-muscle-contraction-l.jpg)
...
![image](https://raw.githubusercontent.com/Jacklyn301/image_bank/main/motor_end_plate_0423.png)
...
![image](https://raw.githubusercontent.com/Jacklyn301/image_bank/main/cardiac_muscle_cell_junctions_0423.png)

#### 收縮過程
```mermaid
flowchart LR
    SA["SA node (竇房結)<br>決定收縮頻率<br>啟動心肌收縮"] --> AV["AV node (房室結)<br>將衝動保持幾毫秒"]
    AV --> His["Bundle of His<br>(希氏束)"]
    His --> LB["Left bundle branch<br>(左束支)"]
    His --> RB["Right bundle branch<br>(右束支)"]
    LB --> PF["Purkinje fibers<br>(浦肯野纖維)"]
    RB --> PF
```
- SA node節律調控由自律神經控制
...
![image](https://raw.githubusercontent.com/Jacklyn301/image_bank/main/smooth_muscle_structure_0423.png)
...
![image](https://raw.githubusercontent.com/Jacklyn301/image_bank/main/single%26multi-unit_smooth_muscle_0423.png)
...
|---------------|--------------|-------------|
|![image](https://media.sciencephoto.com/image/p1540008/800wm/P1540008-Human_skeletal_muscle.jpg)|![image](https://i.ytimg.com/vi/qLZADEperdM/maxresdefault.jpg)|![image](https://www.pathologyoutlines.com/imgau/softtissuesmoothmuscleAli03.jpg)|
...
title Sliding Filament Model 🤔
    depolarization : 動作電位傳入肌膜 : T tubule 去極化 : T管夾在兩側SR的<br>terminal cisternae<br>之間，又被稱為<br>三聯體，triad
    DHPR 偵測電壓 : 二氫吡啶受體--<br>位於T管膜上的<br>電壓感受器 : 感應動作電位<br>的去極化
    RyR 開啟 : 蘭妮鹼受體，位於<br>SR膜上的鈣通道 : 接收來自DHPR<br>的信號，打開並<br>釋放鈣離子
    鈣離子結合 Troponin C : Tropomyosin 移位 : 暴露 actin 結合位點
    Myosin head 與<br>actin 結合 : 形成cross bridge : ATP水解，肌絲滑動
    SERCA pump<br>回收鈣離子 : 收縮結束，肌肉放鬆
```

![image](https://raw.githubusercontent.com/Jacklyn301/image_bank/main/myosin_movement_0424.png)
...
![image](https://raw.githubusercontent.com/Jacklyn301/image_bank/main/smooth_muscle_contraction_0424.png)
...
![image alt](https://thebreathingstudio.com/wp-content/uploads/2020/11/ANS.jpg)
...
![image alt](https://raw.githubusercontent.com/Jacklyn301/image_bank/main/meninges_0424.png)
...
![image alt](https://media-us.amboss.com/media/thumbs/big_5c9b839e6674b.jpg)
...
![image alt](https://img.freepik.com/premium-vector/types-neurons-isolated-white-background-cartoon-style_313437-1037.jpg?w=900)
...
![image alt](https://anatomynote.com/pictures/nervous-system/001/anterior-view-of-ascending-sensory-pathways-of-the-spinal-cord.jpg)
...
![image alt](https://raw.githubusercontent.com/Jacklyn301/image_bank/main/histologic-structure-of-a-peripheral-nerve_0424.jpg)
...
![image alt](https://elsevier-elibrary.com/contents/fullcontent/15189526/epubcontent_v2/OEBPS/images/F00015Xf15-14-9780323789875.jpg)
